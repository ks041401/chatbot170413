...
<html>
    ...
    <%
		...
		builder.setDebugEnabled(true).setOAuthConsumerKey(consumerKey).setOAuthConsumerSecret(consumerSecret)
            ...
            <div class="mp-control-col col-3">
                <div class="mp-table-type1">
                    <table>
                        <thead>
                        <tr>
                            <input type="image" src='/img/wva_kor.png' style='width:33%;height:350px;'>
                            <input type="image" src='/img/wva_eng.png' style='width:33%;height:350px;'>
                            <input type="image" src='/img/dashboard.png' style='width:33%;height:350px;'>
                        </tr>
                        </thead>
                        <tbody>
                        </tbody>
            ...
            <div class="mp-control-col col-4">
                <div class="mp-table-type1">
                    <table style="margin-left:20px;margin-top:10px;">
                        <tbody>
                        	<tr>
	                        	<td><input type="text" class="mp-input-search" placeholder="ID"></td>
	                        </tr>
	                        <tr>
	                        	<td><input type="text" class="mp-input-search" placeholder="PASSWORD" ></td>
	                        </tr>
	                        <tr>
	                        	<td><input type="image" src='/img/btn_login.png' style='width:80%;height:50%;' ></td>
	                        </tr>
	                        <tr>
						    	<td><input type="image" id="twitterLogin" src='/img/twitter.png' style='width:80%;height:100%;'></td>
							</tr>
							<tr>
								<td><input type="image" src='/img/facebook.png'style='width:80%;height:100%;'></td>
							</tr>
							<tr>
								<td><input type="image" src='/img/kakao.png' style='width:80%;height:100%;'></td>
							</tr>
                        </tbody>
                    </table>
                </div><!-- //mp-table-type1 -->
